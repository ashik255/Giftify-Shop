...
const Navigation = () => {
  return (
    <div className="text-center">
      <div className="pt-4">
        <Link style={{ textDecoration: "none", paddingRight:'10px', color:'white' }} to="/home">
          HOME
        </Link>
        <Link style={{ textDecoration: "none", paddingRight:'10px', color:'white' }} to="/shop">
          SHOP
        </Link>
        <Link style={{ textDecoration: "none", paddingRight:'10px',color:'white' }} to="/aura">
          AURA
        </Link>
